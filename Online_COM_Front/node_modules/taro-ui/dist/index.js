    ...
    AtSwipeAction.prototype.render = function () {
        ...
        return (React__default["default"].createElement(components.View, { id: "swipeAction-" + componentId, className: rootClass, style: {
            ...
            React__default["default"].createElement(components.MovableArea, { className: 'at-swipe-action__area', style: {
                ...
                React__default["default"].createElement(components.MovableView, { className: 'at-swipe-action__content', direction: 'horizontal', damping: 50, x: offsetSize, onTouchEnd: this.onTouchEnd, onChange: this.onChange, style: {
                        width: this.eleWidth + "px",
