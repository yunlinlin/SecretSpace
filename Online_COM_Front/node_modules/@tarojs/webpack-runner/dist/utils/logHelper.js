...
exports.printCompiling = exports.printBuildError = exports.getServeSpinner = exports.bindProdLogger = exports.bindDevLogger = void 0;
...
const bindDevLogger = (compiler, devUrl = '') => {
    console.log();
    (0, fp_1.pipe)(printWhenBeforeCompile, (0, fp_1.partial)(printWhenFirstDone, [devUrl]), printWhenDone, printWhenFailed, printWhenInvalid)(compiler);
    return compiler;
};
